...
## Goal
Build a production-ready full-stack Spring Boot application for a Todo List with Thymeleaf frontend and JWT-based authentication using PostgreSQL database.
